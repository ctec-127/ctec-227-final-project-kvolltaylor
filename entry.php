    ...
    <div class='containter'>
        ...
        <form name="entry_form" id="entry_form" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>">
            ...
            <div class="pb-3 ml-4">
                ...
                <p><a class="btn btn-outline-success" data-toggle="collapse" href="#ap_entry" data-target="#ap_entry" role="button" aria-expanded="false" aria-controls="ap_entry">Add a Description</a></p>
            </div>
            </fieldset>
            ...
            <div id="ap_entry" class="collapse mr-4">
                ...
                <legend class="text-dark">Location</legend>
                <div class="form-group">
                    <p class="ml-4">
                ...
                <legend class="text-dark">Time</legend>
                <div class="form-group">
                ...
                <legend class="text-dark">Intensity</legend>
                <div class="form-group ml-4">
                    ...
                    <div class="form-check-inline">
                        <input type="radio" id="ap_med" name="anxiety_level" value="2" <?=$checked_1?>><label class="form-check-label" for="ap_med">Somewhat Stessful</label>
                    </div>
                    <div class="form-check-inline">
                        <input type="radio" id="ap_hi" name="anxiety_level" value="3" <?=$checked_1?>><label class="form-check-label" for="ap_hi">Very Stressful</label>
                    </div>
                </div>
                </fieldset>
                ...
                <!-- notes -->
                <fieldset class="border border-secondary rounded p-2 mb-4 shadow bg-white">
                <legend class="text-dark">Notes</legend>
                <div class="form-group">
                    <label for="event_text" class="ml-4">A space for you to add any important notes you'd like to make.</label>
                    <br>
                    <textarea id="event_text" name="event_text" class="form-control lg-input mx-4 pr-4" rows="7"></textarea>
                    <br><br>
                </div>
                </fieldset>
        ...
        </div> <!-- end second div containing form -->
...
<!-- // function sliderValue(){
            ...
            //             console.log('Slider value is ' + response);
            //         },
            //         error: function(){
            //             console.log("Error with slider function");
            //         }
            //     });
            // }
...
//         function sliderValue(){
//             let slider = $('#slider').slider("option","value");
//             $.ajax({
//             type: 'POST',
//             url: 'inc/content/session-backend-slider.inc.php',
